...
#Seccion descartada (puntos de soldadura)
"""
x = ladohex+aleta/2
...
# Creacion de las placas de impacto
p = mdb.models['Model-1'].parts['Chapa']
session.viewports['Viewport: 1'].setValues(displayedObject=p)
s = mdb.models['Model-1'].ConstrainedSketch(name='__profile__', 
    sheetSize=200.0)
...
#--------------------------------------------------------------------------
# Interacciones y contactos: revisar linea ~330, entre otras
#--------------------------------------------------------------------------
...
# Colocaion de puntos de soldadura
...
#Creacion de los ties con laser
"""
a = mdb.models['Model-1'].rootAssembly
s1 = a.instances['Chapa-1'].faces
side1Faces1 = s1[4:5]
