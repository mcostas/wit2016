...
\begin{figure}
	...
	\caption[Cross section detail of the adhesive layer modelled with \acrlongpl{COH3D} between two adherends modelled with shell elements.]{Cross section detail of the adhesive layer modelled with \acrlongpl{COH3D} between two adherends modelled with shell elements. Taken from \cite{Scattina2011}.}
	\label{fig:union}
\end{figure}
